//
//  AcceptConsentsViewController.swift
//  AssignmentOpenBank
//
...
final class AcceptConsentsViewController: BaseViewController {

    override var prefersNavigationBarHidden: Bool { return true }
    
    var presenter: AcceptConsentsPresenterProtocol!
...
// MARK: - AcceptConsentsViewControllerProtocol
extension AcceptConsentsViewController: AcceptConsentsViewControllerProtocol {
...
extension AcceptConsentsViewController: WKNavigationDelegate {
...
extension AcceptConsentsViewController: TopBarWebViewDelegate {
