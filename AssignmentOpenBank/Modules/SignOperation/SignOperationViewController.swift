//
//  SignOperationViewController.swift
//  AssignmentOpenBank
//
...
final class SignOperationViewController: BaseViewController {

    override var prefersNavigationBarHidden: Bool { return true }
    
    var presenter: SignOperationPresenterProtocol!
...
// MARK: - SignOperationViewControllerProtocol
extension SignOperationViewController: SignOperationViewControllerProtocol {
...
extension SignOperationViewController: WKNavigationDelegate {
...
extension SignOperationViewController: TopBarWebViewDelegate {
