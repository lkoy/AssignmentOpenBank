...
class SantanderApiRequestRetrier: APIRequestRetrierProtocol {
    
    static let global: SantanderApiRequestRetrier = SantanderApiRequestRetrier()
    ...
    public init(withSantanderKeychain santanderKeychain: CodableKeychain<SantanderModels.Token> = SantanderAuthTokenKeychainBuilder.build()) {
